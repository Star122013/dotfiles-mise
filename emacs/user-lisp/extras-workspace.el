;;; extras-workspace.el --- Workspace management (tab-bar-mode + tabspaces) -*- lexical-binding: t; -*-

;;; Commentary:
;;; Workspace management using tab-bar-mode and tabspaces.
;;; Extracted from extras-dev.el for modularity.
...
(provide 'extras-workspace)
;; Local Variables:
;; no-byte-compile: t
;; End:
;;; extras-workspace.el ends here
