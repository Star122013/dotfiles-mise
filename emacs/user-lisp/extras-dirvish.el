;;; extras-dirvish.el --- Dired beautification and enhancement -*- lexical-binding: t; -*-

;;; Commentary:
;;; Modern file manager based on Emacs built-in Dired.
...
(use-package
  ...
  (("C-c d" . dirvish)
   ...
   ;; ("?" . dirvish-dispatch) ; [?] a helpful cheatsheet -- already bound by dirvish default
...
(provide 'extras-dirvish)
;; Local Variables:
;; no-byte-compile: t
;; End:
;;; extras-dirvish.el ends here
